...
_EXPLICIT_STRATEGIC_PHRASES = (
    ...
    "قطع برق", "برق سراسری", "خاموشی سراسری",
...
def match_strategic_resource(name: str):
    ...
    # «قطع برق» و «برق سراسری» عبارت‌های رایج رول‌های خاموشی‌اند؛ «برق» به‌تنهایی
    # عمداً پذیرفته نیست تا سامانه‌هایی مثل «برق-۲» اشتباه راهبردی شمرده نشوند.
