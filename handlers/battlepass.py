...
async def require_country(update: Update):
    ...
    if not country:
        if update.message:
            await update.message.reply_text("❌ شما هنوز کشوری در بازی ثبت نکرده‌اید. برای شروع /start را بزنید.")
...
async def battlepass_buy_pass_prompt(query, context, user_id: int):
    ...
    text = (
        ...
        "• 💰 <b>بیش از ۶۰۰ میلیون دلار</b> پاداش نقد خزانه در ۲۰ لول\n"
        "• 🛢️ <b>بیش از ۱ میلیون بشکه نفت</b> و صدها شمش طلا\n"
        "• ✈️ <b>جنگنده‌های رادارگریز نسل ۵ شبح</b> + موشک‌های بالستیک سنگین\n"
        "• 🛸 <b>ناوگان پهپادهای انتحاری نقطه‌زن</b> و زیردریایی‌های تهاجمی\n"
        "• ⚡ <b>+۲۵٪ بوست دائمی XP</b> برای باز کردن برق‌آسای تمام لول‌ها\n"
        "• 👑 <b>تندیس طلایی و نشان اختصاصی «Warzone Supreme Lord»</b>\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━\n"
