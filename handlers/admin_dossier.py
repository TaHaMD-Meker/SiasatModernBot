...
async def show_country_dashboard(query, context, country_id: int, notice: str = ""):
    ...
    lines = [
        ...
        f"• 🌾 <b>غلات:</b> <code>{format_number(c['grain'])} تن</code> | ⚡ <b>برق:</b> <code>{c.get('electricity', 0)} MW</code>",
        f"• 🪙 <b>طلا:</b> <code>{format_number(c['gold'])} شمش</code> | 💻 <b>میکروچیپ:</b> <code>{format_number(c.get('microchips', 0))} چیپ</code>",
